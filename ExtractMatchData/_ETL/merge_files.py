...
def merge_csv_files(tournaments_df):
    columns_to_drop = {
        ...
        "_players.csv": ["score", "mvp", "rank_type", "rank", "old_rank", "win_count", "bomb_planted", "bomb_defused", "hostage_rescued", "1v1", "1v2", "1v3", "1v4", "1v5", "1v1_won", "1v2_won", "1v3_won", "1v4_won", "1v5_won", "1v1_lost", "1v2_lost", "1v3_lost", "1v4_lost", "1v5_lost", "htlv_2", "htlv", "crosshair_share_code", "color", "inspect_weapon_count", "source_file"],
