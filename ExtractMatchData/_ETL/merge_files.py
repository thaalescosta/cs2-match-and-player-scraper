...
def merge_csv_files(tournaments_df):
    columns_to_drop = {
        ...
        "_match.csv": ["game", "demo_path", "demo_name", "source", "type", "share_code", "server_name", "client_name", "tick_count", "tickrate", "framerate", "game_type", "game_mode", "game_mode_str", "is_ranked", "duration", "network_protocol", "build_number", "shot_count", "winner_name", "winner_side", "overtime_count", "max_rounds", "has_vac_live_ban", "source_file"],
    ...
    tournaments_df = tournaments_df.drop(columns={'root', 'url_request', 'direct_url_demo', 'file_name', 'demo_path', 'output_data_path'}, inplace=True)
