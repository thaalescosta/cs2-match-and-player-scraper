...
def unrar(tournaments_df):
    ...
    '''
    rarfile.UNRAR_TOOL = os.path.join(root, r"_resources", "unrar.exe")  # Path for the unrar executable

    # Define the source folder containing .rar files
    source_folder = './downloads/demos'
    ...
    for rar_filename in rar_files:
        ...
        destination_folder = f'./downloads/unpacked_demos/{tournament}'
